function calcu() {
  ...
  var ch1tt = document.getElementById('ch1tt').value = Number((ch1ntd)*0.25+(ch1ctrl*0.5)+(ch1ntp*0.25));
    ...
    // Calculations
    let u1tt =  document.getElementById("u1tt").value = ((2 * alg1tt) + (3 * ch1tt) + (3 * ph1tt))/8;
    let u2tt = document.getElementById("u2tt").value = (info1tt + eng1tt)/2;
    let u3tt = document.getElementById("u3tt").value = (ana1tt + pro1tt)/2;
